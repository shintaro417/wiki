...
?>
<form method="post" action="wiki_edit_check.php?id=<?php print $_POST['id'];?>">
  <input type="hidden" name="id" value="<?php print $_GET['id'];?>">
  <dt><span class="required">タイトル名</span></dt>
  <dd><input type="text" name="title" class="title" value="<?php print $_POST['title'];?>"></dd>
  <dt><span class="required">記事</span></dt>
  <dd><textarea  name="sentence" class="article"><?php print $_POST['sentence'];?></textarea></dd>
